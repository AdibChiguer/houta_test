...
@Epic("Tests Marjanemall")
@Feature("Recherche")
@Owner("SOUFYANE")
public class TestRecherche extends ChromeTestBase {
        private static final String SEARCH_BAR_XPATH = "//*[@id=\"autocomplete-0-input\"]";
        private static final String STRING_TO_SEARCH_FR = "batterie";
        private static final String STRING_TO_SEARCH_EN = "battery";
        private static final String STRING_INSENSITIVE_CASSE  = "BatTerY";
        private static final String STRING_NOT_EXISTS = "inexistant";
        private static final String PRODUCT_CLASS = "product-item-info";
        private static final String PRODUCTS_CLASS = "products";
        private static final String CLASS_SEARCH_NO_RESULTS_WRAPPER = "ais-InfiniteHits--empty";
    ...
    public void testRechercheBatterie() {
        ...
        searchInput.sendKeys(STRING_TO_SEARCH_FR);
        searchInput.sendKeys(Keys.ENTER);

        wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.className(PRODUCTS_CLASS)));

        // Find all product elements on the search result page
        List<WebElement> produits = driver.findElements(By.className(PRODUCT_CLASS));
        ...
        for (WebElement produit : produits) {
            ...
            if (texte.contains(STRING_TO_SEARCH_FR) || texte.contains(STRING_TO_SEARCH_EN))
                continue;
            ...
            try {
                ...
                Assert.assertTrue(
                        descTexte.contains(STRING_TO_SEARCH_FR) || descTexte.contains(STRING_TO_SEARCH_EN),
                ...
                wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.className(PRODUCT_CLASS)));
            }
        }
    }
    ...
    public void testRechercheProduitInexistant() {
        WebElement searchInput = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath(SEARCH_BAR_XPATH)));
        searchInput.sendKeys(STRING_NOT_EXISTS);
        searchInput.sendKeys(Keys.ENTER);
    ...
    public void testRechercheAvecLongTexte() {
        ...
        String longText = "inexistant ".repeat(500); // Génère une chaîne de 300 'x'
...
//    Recherche insensible à la casse
    ...
    public void testRechercheInsensitiveCasse() {
        ...
        searchInput.sendKeys(STRING_INSENSITIVE_CASSE); // casse aléatoire
        searchInput.sendKeys(Keys.ENTER);
